...
import (
	...
	"github.com/coinsky/sky-sdk/modules/incentive/client/cli"
	"github.com/coinsky/sky-sdk/modules/incentive/client/rest"
...
type AppModule struct {
	AppModuleBasic
	incentiveKeeper keepers.Keeper
}
...
func (am AppModule) BeginBlock(ctx sdk.Context, _ abci.RequestBeginBlock) {
	BeginBlocker(ctx, am.incentiveKeeper)
}
